...
CATEGORY_SUBJECTS = {
    Category.SPAM: ['подтвердите', '15!', 'iphone', 'выиграли', 'exclusive', 'верификация', 'time', 'limited',
                    'offer', 'личность'],
    Category.INCIDENTS: ['ошибка', 'обновления', 'остановлена', 'работа', 'падает',
                         'отдела', 'войти', 'могу', 'антивирус', 'критический', 'запускается', 'недоступен',
                         'bi-система', 'инцидент', 'авторизации', 'массовый', 'сбой', 'reader', 'браузер', 'chrome',
                         'зависает'],
    Category.REQUEST: ['доступа', 'запрос', 'оборудования:', 'сотрудника', 'нового',
                       'неисправность', 'права', 'нужны', 'vpn', 'гарнитура', 'нет', 'после', 'перевода', 'проблема',
                       'почта',
                       'ноутбук', 'заявка', 'отпуск', 'лист', 'больничный', 'изменение', 'работы', 'графика'],
    Category.FINANCE: ['уточнение', 'оплате', 'договора', 'документы', 'закрывающие', 'правки', 'финальная',
                       'инструкция',
...
CATEGORY_WEIGHTS_SUBJECT = {
    Category.SPAM: 0.55,
    Category.INCIDENTS: 0.60,
    Category.REQUEST: 0.436,
    Category.FINANCE: 0.429
}
